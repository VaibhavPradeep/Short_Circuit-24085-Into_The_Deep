...
@Config
@Autonomous(name = "RR1SpecimenAndPushing")
public class RR1SpecimenAndPushing extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d pose3 = new Pose2d(9.5, -55, Math.toRadians(startHeading));
